...
public class AppWindowAdmin {
    ...
    private void initialize() {
        ...
        passwordField.setToolTipText("Poprawne podanie has\u0142a umo\u017Cliwia dost\u0119p do panelu adminiastratora");
        ...
        panel_4.setBorder(new TitledBorder(null, "Sta³e œrodowiskowe", TitledBorder.LEADING, TitledBorder.TOP, null, null));
