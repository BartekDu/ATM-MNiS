...
public class ATM implements IATM {
	...
	public void saveIterationInformation() {
		...
		for (Integer noteValue : notesValues) {
			iterationLog
					.addNotesCountInformation((noteValue + "PLN" + " = " + notesCount
							.get(noteValue)));
		}
	...
	@Override
	public void refillNotes(int PLN200Count, int PLN100Count, int PLN50Count,
			int PLN20Count, int PLN10Count) {
		int[] additionalCountTab = { PLN200Count, PLN100Count, PLN50Count,
				PLN20Count, PLN10Count };
